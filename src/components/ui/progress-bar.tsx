    ...
    <div className={`w-full ${className}`}>
      <div className="flex items-baseline justify-between gap-3">
        ...
        >
          ...
          <motion.span
            className="mono col-start-1 row-start-1 whitespace-nowrap text-[12px] font-medium leading-5 tabular-nums"
            initial={false}
      ...
      <div
        ...
        aria-valuemax={max}
        {...measured}
        className="mt-2 rounded-[4px] bg-muted p-[2px] shadow-[inset_0_1px_2px_rgba(0,0,0,0.45)]"
      >
        <div className="relative h-[8px] overflow-hidden rounded-[2px]">
          <motion.span
            aria-hidden
            className="absolute inset-0 block origin-left rounded-[2px] bg-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.4),inset_0_-1px_0_rgba(0,0,0,0.25)]"
            initial={false}
          ...
          {indeterminate && !reduced ? (
            <motion.span
              aria-hidden
              className="absolute inset-y-0 left-0 block w-2/5 rounded-[2px] bg-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.4),inset_0_-1px_0_rgba(0,0,0,0.25)]"
